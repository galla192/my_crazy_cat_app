class RecyclersController < ApplicationController
  ...
  private
    ...
    def recycler_params
      params.require(:recycler).permit(:name, :address, :phone, :website, :email, :accepts_white_computer_paper, :accepts_corrugated_cardboard, :accepts_color_seperated_glass)
    end
end
